...
export class DeliveryAddresses extends DeliveryAddressesWrapperItems {
	...
	#handleClickChoose = (cartFormDeliveryPoint, cartFormDeliveryStyles) => {
		sessionStorage.setItem(
			'delivery address',
			JSON.stringify(this.getDeliveryAddressInfo)
		)
	...
	draw(way, cartFormDeliveryPoint, cartFormDeliveryStyles) {
		...
		this.deliveryAddressesBtnChoose.element.addEventListener('click', () =>
			this.#handleClickChoose(cartFormDeliveryPoint, cartFormDeliveryStyles)
		)
